...
#RequireAdmin
ToolTip("League of FPS PRO" &@CRLF &"Bạn Hãy Khởi Động Liên Minh Huyền Thoại, phần mềm sẽ tắt một số tác vụ và dọn dẹp Ram Cho bạn" & @CRLF & "Bạn Có thể hủy tác vụ này bằng cách tắt biểu tượng phần mềm dưới thanh system tray",-1,-1)
